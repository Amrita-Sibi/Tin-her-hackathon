...
* **AI Image Scanning**: Upload a photo of any medicine strip to extract active compounds and medical data via OCR and Multimodal AI.
* **Intelligent Search**: Type the name of a medicine to get a detailed breakdown of its uses and risks without needing a local database.
* **Dynamic UI**: A clean, modern Tailwind CSS dashboard that updates in real-time based on AI analysis.
* **Professional Logic**: Backend integration using Flask and Python to handle secure API communication and image processing.
